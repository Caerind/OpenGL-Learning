...
#define IM_VEC4_CLASS_EXTRA                                                 \
		...
		ImVec4(const cmgl::Color& color) { x = color.r / 255.0f; y = color.g / 255.0f; z = color.b / 255.0f; w = color.a / 255.0f; }                                \
		operator cmgl::Color() const { return cmgl::Color((float*)this); }
